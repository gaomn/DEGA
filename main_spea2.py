...
if __name__ == '__main__':
    ...
    parser.add_argument('--number_of_colonies', type=int, default=2)
    parser.add_argument('--popsize_per_colony', type=int, default=50)
    parser.add_argument('--alpha', type=float, default=1)
    parser.add_argument('--beta', type=float, default=2)
    parser.add_argument('--q0', type=float, default=0.9)
    parser.add_argument('--rho_l', type=float, default=0.1)
    parser.add_argument('--rho_g', type=float, default=0.1)
    parser.add_argument('--insConfDir', type=str, default='./AllInstance/')
    parser.add_argument('--method', type=str, default='SPEA2', choices=['DEGA', 'ILS', 'MSGA', 'CACS'])
